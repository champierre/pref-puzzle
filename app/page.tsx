    ...
    <>
      <div className="max-w-xl mx-auto px-4 py-12 flex flex-col gap-10">
        ...
        <footer className="text-xs text-gray-300 border-t border-gray-800 pt-5 flex flex-col gap-1">
          ...
          <span>ソース: <a href="https://github.com/tukumanalab/pref-puzzle" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-200 transition-colors">GitHub</a></span>
        </footer>
      </div>
